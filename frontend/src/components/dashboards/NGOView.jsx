...
const NGOView = () => {
    ...
    const formik = useFormik({
        ...
        validate: values => {
            ...
            if (!values.request_food_type) {
                errors.request_food_type = 'Required';
            }

            if (!values.required_quantity) {
                errors.required_quantity = 'Required';
            } else if (values.required_quantity <= 0) {
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="bg-[#111827] border border-gray-800 rounded-2xl p-6 md:p-8">
                                ...
                                <p className="text-sm text-gray-400 mb-8">
                                    Request food donations for your organization
                                </p>
                        ...
                        <div className="grid md:grid-cols-2 gap-8 items-start">
                            <div className="bg-[#111827] p-6 md:p-8 rounded-2xl shadow-sm border border-gray-800">
                                ...
                                <p className="text-sm text-gray-500 mb-6">
                                    Enter details about your food requirement
                                </p>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 py-3 bg-[#0f172a] text-white border rounded-xl focus:ring-2 outline-none transition-colors ${
                                                formik.touched.request_food_type &&
                                                formik.errors.request_food_type
                ...
                return (
                    <div className="space-y-6 animate-in fade-in duration-500">
                        <div>
                            ...
                            <p className="text-sm text-gray-400 mt-1">
                                View your food request history
                            </p>
                        </div>
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">
                                        Complete history of your food requests
                                    </p>
                                </div>
                                ...
                                <div className="flex flex-wrap gap-3">
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setFilters({
                                                ...filters,
                                                request_food_type: e.target.value
                                            })
                                        }
                ...
                return (
                    <div className="space-y-6 animate-in fade-in duration-500">
                        <div>
                            ...
                            <p className="text-sm text-gray-400 mt-1">
                                View assignments for your food requests
                            </p>
                        </div>
                        ...
                        <div className="bg-[#111827] p-6 md:p-8 rounded-2xl shadow-sm border border-gray-800">
                            ...
                            <p className="text-sm text-gray-500 mb-8">
                                Donations matched to your requests
                            </p>
                            ...
                            >
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        value={
                                            editModal.data.request_food_type
                                        }
                                        onChange={e =>
                                            setEditModal(prev => ({
                                                ...prev,
                                ...
                                <div>
                                    ...
                                    <input
                                        type="number"
                                        value={
                                            editModal.data.required_quantity
                                        }
                                        onChange={e =>
                                            setEditModal(prev => ({
                                                ...prev,
